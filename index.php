                ...
                <div class="row">
                    <div class="col-lg-12">
                        <div class="hero-content">
                            ...
                            <a data-duration-in=".5" data-animation-in="fadeInDown" data-delay-in="1.3" href="#" class="btn btn-outline text-uppercase more-btn">more details</a>
                        </div>
                    </div>
                </div>
            </div>
        ...
        <div class="hero-slider-item py-160" style="background-image: url(images/banner/banner-2.jpg);" data-icon="ti-bar-chart" data-text="Marketting">
            <div class="container">
                <div class="row">
                    <div class="col-lg-12">
                        <div class="hero-content">
                            <h4 class="text-uppercase mb-1" data-duration-in=".5" data-animation-in="fadeInDown" data-delay-in=".1">We are here to</h4>
                            <h1 class="font-weight-bold mb-3" data-duration-in=".5" data-animation-in="fadeInDown" data-delay-in=".5">Planning Business</h1>
    ...
    <div class="container">
        <div class="row justify-content-center">
            <div class="col-lg-12 text-center">
                ...
                <h2 class="section-title section-title-border rezol-title">Service We Provide</h2>
            </div>
            <!-- service item -->
            <div class="col-lg-4 col-sm-6 mb-5 mb-lg-0">
                <div class="card text-center">
                    ...
                    <div class="card-body p-0">
                        <i class="square-icon translateY-33 rounded ti-bar-chart rezol-bg2"></i>
                        ...
                        <a href="service-single.html" id="read1" class="btn btn-secondary translateY-25">Read More</a>
                    </div>
                </div>
            </div>
            <!-- service item -->
            <div class="col-lg-4 col-sm-6 mb-5 mb-lg-0">
                <div class="card text-center">
                    ...
                    <div class="card-body p-0">
                        <i class="square-icon translateY-33 rounded ti-thought rezol-bg2"></i>
                        <p class="card-text mx-2 mb-0">Lorem ipsum dolor amet consecte tur adipisicing elit sed done eius mod tempor enim ad minim veniam quis nostrud.</p>
                        <a href="service-single.html" id="read2" class="btn btn-secondary translateY-25">Read More</a>
                    </div>
                </div>
            </div>
            <!-- service item -->
            <div class="col-lg-4 col-sm-6">
                <div class="card text-center">
                    ...
                    <div class="card-body p-0">
                        <i class="square-icon translateY-33 rounded ti-server rezol-bg2"></i>
                        <p class="card-text mx-2 mb-0">Lorem ipsum dolor amet consecte tur adipisicing elit sed done eius mod tempor enim ad minim veniam quis nostrud.</p>
                        <a href="service-single.html" id="read3" class="btn btn-secondary translateY-25">Read More</a>
                    </div>
                </div>
            </div>
        </div>
        ...
        <div class="row">
            <div class="col-lg-6 ml-auto">
                <div class="rounded p-sm-5 px-3 py-5 bg-secondary">
                    <h3 class="section-title section-title-border-half text-white rezol-title">Who We Are?</h3>
                    ...
                    <div>
                        <ul class="d-inline-block pl-0">
                            <li class="font-secondary mb-10 text-white float-sm-left mr-sm-5">
                                <i class="mr-2 ti-arrow-circle-right"></i>Business Services</li>
                            <li class="font-secondary mb-10 text-white">
                                <i class="text-primary mr-2 ti-arrow-circle-right"></i>Audit &amp; Assurance</li>
                            <li class="font-secondary mb-10 text-white">
                                <i class="mr-2 ti-arrow-circle-right"></i>IT Control Solutions</li>
                        </ul>
                        <ul class="d-inline-block pl-0">
                            <li class="font-secondary mb-10 text-white">
                                <i class="mr-2 ti-arrow-circle-right"></i>Business Services</li>
                            <li class="font-secondary mb-10 text-white">
                                <i class="mr-2 ti-arrow-circle-right"></i>Audit &amp; Assurance</li>
                            <li class="font-secondary mb-10 text-white">
                                <i class="mr-2 ti-arrow-circle-right"></i>IT Control Solutions</li>
                        </ul>
                    </div>
                    <a href="#" class="btn mt-4 rezol-btn1">Explore More</a>
                </div>
            </div>
        </div>
    </div>
...
<section class="section">
    <div class="container">
        <div class="row">
            <div class="col-lg-12">
                <h5 class="section-title-sm">Best Service</h5>
                <h2 class="section-title section-title-border-half rezol-title">Why Choose Us</h2>
            </div>
            <div class="col-lg-7">
                <div class="mb-40">
                    ...
                    <div class="row">
                        <div class="col-4">
                            <div class="d-flex flex-column flex-sm-row align-items-center">
                                <i class="round-icon mr-sm-3 ti-server rezol-text2"></i>
                        ...
                        <div class="col-4">
                            <div class="d-flex flex-column flex-sm-row align-items-center">
                                <i class="round-icon mr-sm-3 ti-face-smile rezol-text2"></i>
                                <div class="text-center text-sm-left">
                        ...
                        <div class="col-4">
                            <div class="d-flex flex-column flex-sm-row align-items-center">
                                <i class="round-icon mr-sm-3 ti-thumb-up rezol-text2"></i>
                                <div class="text-center text-sm-left">
    ...
    <div class="container-fluid">
        <div class="row">
            <div class="col-lg-12 text-center">
                ...
                <h2 class="section-title section-title-border-gray rezol-title">Latest Projects</h2>
            </div>
        </div>
        <!-- work slider -->
    ...
    <div class="container">
        <div class="row">
            <div class="col-lg-12">
                ...
                <h2 class="section-title section-title-border-half rezol-title">Company Mission</h2>
                <div class="row">
                    <div class="col-lg-6">
                ...
                <div id="accordion" class="mb-md-50">
                    <div class="card border-0 mb-4">
                        <div class="card-header bg-gray border p-0">
                            <a class="card-link h5 d-block tex-dark mb-0 py-10 px-4 h4" data-toggle="collapse" href="#collapseOne">
                                <i class="ti-minus text-primary mr-2 plus"></i> Our Company Mission
                            </a>
                        </div>
                    ...
                    <div class="card border-0 mb-4">
                        <div class="card-header bg-gray border p-0">
                            <a class="collapsed card-link h5 d-block tex-dark mb-0 py-10 px-4 h4" data-toggle="collapse" href="#collapseTwo">
                                <i class="ti-plus text-primary mr-2 plus"></i> Our Company Mission
                            </a>
                        </div>
                    ...
                    <div class="card border-0 mb-4">
                        <div class="card-header bg-gray border p-0">
                            <a class="collapsed card-link h5 d-block tex-dark mb-0 py-10 px-4 h4" data-toggle="collapse" href="#collapseThree">
    ...
    <div class="container">
        <div class="row">
            <div class="col-lg-12 text-center">
                ...
                <h2 class="section-title section-title-border rezol-title"> What client Say </h2>
            </div>
    ...
    <div class="container">
        <div class="row justify-content-center">
            <div class="col-lg-12 text-center">
                ...
                <h2 class="section-title section-title-border-gray rezol-title">Company News</h2>
            </div>
            <!-- blog-item -->
                    ...
                    <div class="card-body p-0">
                        <div class="d-flex">
                            <div class="py-3 px-4 border-right text-center">
                                <h3 class="rezol-text2 mb-0">25</h3>
                                <p class="mb-0">Nov</p>
                            </div>
                            <div class="p-3">
                                <a href="blog-single.html" class="h4 font-primary">Cras sed elit sit amet.</a>
                                <p>by Admin</p>
                            </div>
                        </div>
                    </div>
            ...
            <div class="col-lg-4 col-12">
                <ul class="bg-white border rounded pl-0">
                    ...
                    <li class="d-flex">
                        ...
                        <div class="p-3">
                            <a href="blog-single.html" class="h4 font-primary
                            ">Cras sed elit sit amet.</a>
                            <p>by Admin</p>
                        </div>
                    </li>
                </ul>
